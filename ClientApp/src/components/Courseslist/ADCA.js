...
const ADCA = () => {
  ...
  return (
    <motion.div className='ADCA'
    initial={{width:0}}
    animate={{width:"100%"}}
    exit={{x: window.innerWidth, transition: {duration:0.3}}}
    >
        <div className='ADmain'>
        <div className="Scontact"><div className="stikybox"><h3>ADCA | 12 Months</h3></div></div>
...
<Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
 ...
 <Accordion expanded={expanded === 'panel7'} onChange={handleChange('panel7')}>
   <AccordionSummary
     ...
     id="panel7bh-header"
   >
    <li>Graphic Design - Photoshop & CorelDRAW</li>
   </AccordionSummary>
   <AccordionDetails>
     <Typography>
       Nunc vitae orci ultricies, auctor nunc in, volutpat nisl. Integer sit
 ...
 <Accordion expanded={expanded === 'panel10'} onChange={handleChange('panel10')}>
   <AccordionSummary
     ...
     id="panel10bh-header"
   >
    <li>Financial Accounting using - Tally Prime</li>
 ...
 <Accordion expanded={expanded === 'panel14'} onChange={handleChange('panel14')}>
   <AccordionSummary
     ...
     id="panel14bh-header"
   >
     <li sx={{ flexShrink: 0 }}>PC Maintanance, Security & Troubleshooting</li>
   </AccordionSummary>
   <AccordionDetails>
     <Typography>
       Nunc vitae orci ultricies, auctor nunc in, volutpat nisl. Integer sit
 ...
 <Accordion expanded={expanded === 'panel18'} onChange={handleChange('panel18')}>
   <AccordionSummary
     ...
     id="panel18bh-header"
   >
     <li>Latest Trends in IECT & e-Governace</li>
   </AccordionSummary>
   <AccordionDetails>
     <Typography>
       Nunc vitae orci ultricies, auctor nunc in, volutpat nisl. Integer sit
